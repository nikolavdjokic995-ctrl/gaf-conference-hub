...
urlpatterns = [
    ...
    path("review-invitation/<int:assignment_id>/", review_invitation_response, name="review_invitation_response"),
    ...
    path("conference/<slug:slug>/settings/storage/", storage_status, name="storage_status"),
