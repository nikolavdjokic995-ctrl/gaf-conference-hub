...
class ConferenceOverviewForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "hub_container_width": forms.NumberInput(attrs={"min": 520, "max": 1800, "step": 10}),
            "hub_left_margin": forms.NumberInput(attrs={"min": 0, "max": 900, "step": 10}),
            "hub_background_image_width": forms.NumberInput(attrs={"min": 30, "max": 200, "step": 5}),
            "hub_background_image_opacity": forms.NumberInput(attrs={"min": 0, "max": 1, "step": 0.05}),
            "hub_logo_width": forms.NumberInput(attrs={"min": 40, "max": 320, "step": 10}),
            "hub_card_radius": forms.NumberInput(attrs={"min": 0, "max": 60, "step": 1}),
            "hub_card_padding": forms.NumberInput(attrs={"min": 8, "max": 80, "step": 2}),
            ...
            "overview_menu_left": forms.NumberInput(attrs={"min": 0, "max": 500, "step": 5}),
            "overview_menu_top": forms.NumberInput(attrs={"min": 0, "max": 400, "step": 5}),
            "overview_menu_opacity": forms.NumberInput(attrs={"min": 0.1, "max": 1, "step": 0.05}),
        ...
        labels = {
            ...
            "hub_header_background": "Hub header background colour",
            "hub_card_background": "Hub card background colour",
            "hub_title_color": "Hub title colour",
            "hub_text_color": "Hub text colour",
            "hub_container_width": "Hub content/card width",
            "hub_left_margin": "Hub content left margin",
            "hub_background_image_width": "Hub background image zoom (%)",
            "hub_background_image_opacity": "Hub background image opacity",
            "hub_logo_width": "Hub logo width",
            "hub_card_radius": "Hub card corner radius",
            "hub_card_padding": "Hub card padding",
            ...
            "overview_menu_left": "Left menu horizontal position",
            "overview_menu_top": "Left menu vertical position",
            "overview_menu_opacity": "Left menu transparency",
            "overview_content_width": "Overview content width",
            "overview_card_background": "Extra card background colour",
