...
class Submission(models.Model):
    ...
    is_student_paper = models.BooleanField(
        default=False,
...
class EmailTemplate(models.Model):
    EVENT_CHOICES = [
        ...
        ("review_invitation_cancelled", "4a. Review invitation cancelled – Reviewer notification"),
        ("review_declined_judge", "4b. Reviewer declined invitation – Judge notification"),
        ("review_declined_author", "4c. Reviewer declined invitation – Author notification"),
        ...
        ("accepted_for_layout", "12a. Manuscript accepted for layout preparation"),
