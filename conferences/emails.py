...
def build_email_context(submission=None, reviewer=None, request=None, extra=None, assignment=None, conference=None):
    ...
    context = {
        ...
        "my_submissions_link": absolute_url(request, "my_submissions") if submission else "",
        "submission_link": absolute_url(request, "my_submissions") if submission else "",
        ...
        "publication_approval_link": absolute_url(request, "my_submissions") if submission else "",
        "final_publication_word_file_link": file_absolute_url(request, getattr(submission, "final_publication_word_file", None)) if submission else "",
        "final_publication_pdf_file_link": file_absolute_url(request, getattr(submission, "final_publication_pdf_file", None)) if submission else "",
        "final_publication_file_link": file_absolute_url(request, getattr(submission, "final_publication_file", None)) if submission else "",
        "author_publication_comment": getattr(submission, "author_publication_comment", "") if submission else "",
...
def preview_template(template, submission=None, reviewer=None, request=None):
    ...
    if not submission:
        context.update({
            ...
            "my_submissions_link": "https://example.com/my-submissions/",
            "submission_link": "https://example.com/my-submissions/",
